...
class __TwigTemplate_c49222f520251f0ee456995c082129cd146c65c1e2c7696d46ce6a21165752a5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('evaluation_delete', {'id': evaluation.id}) }}\" 
onsubmit=\"return confirm('Etes-vous sure de vouloir supprimer cet apprenant?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ evaluation.id) }}\">
    <button class=\"btn btn-danger\">Supprimer</button>
</form>
", "evaluation/_delete_form.html.twig", "C:\\Users\\JUnior\\Desktop\\Atelier7_Simplon-ONFP\\templates\\evaluation\\_delete_form.html.twig");
    }
}
